...
try:
    ...
    if not os.path.exists(filename):
        ...
        processed_features = utils.re_features_push_structure(raw_adj_sp, original_adj, features, 1, args.num_structure_tokens, args.num_structure_supernodes, cluster_dict, edge_weights, edge_indices)  # return (N, num_structure_tokens + 1, d)
        processed_features = utils.re_features_push_content(original_adj, processed_features, features, args.num_content_tokens, num_labels, labelcluster_to_nodes, edge_weights, edge_indices) # return (N, num_content_tokens + num_structure_tokens + 1, d)
